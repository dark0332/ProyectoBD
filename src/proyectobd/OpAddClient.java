 ...
 * @author GVXTR
 */
public class OpAddClient extends javax.swing.JFrame {
...
//    static ResultSet rs;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpAddClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OpAddClient().setVisible(true);
            }
        });
    }
